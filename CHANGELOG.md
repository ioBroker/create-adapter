...
-->
## __WORK IN PROGRESS__
* (copilot) Use new i18n directory structure - change from admin/i18n/en/translations.json to admin/i18n/en.json (#1130) · [Migration guide](docs/updates/20250910_i18n_directory_structure.md)

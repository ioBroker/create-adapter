...
* (UncleSamSwiss) Fixed adapter-react dependencies by using `@iobroker/adapter-react` version 1.6.15 · [Migration guide](docs/updates/20210510_adapter-react-fix.md)

...
* (copilot) Remove fa-icon from adminTab configuration to comply with Admin 5 requirements (#741) · [Migration guide](docs/updates/20250102_remove_admin_tab_fa_icon.md)

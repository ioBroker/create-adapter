...
const templates: { name: string, templateFunction: TemplateFunction }[] = [
	...
	{ name: "admin/i18n/en/translations.json.ts", templateFunction: require("./admin/i18n/en/translations.json") },
	{ name: "admin/i18n/es/translations.json.ts", templateFunction: require("./admin/i18n/es/translations.json") },
	{ name: "admin/i18n/fr/translations.json.ts", templateFunction: require("./admin/i18n/fr/translations.json") },
	{ name: "admin/i18n/it/translations.json.ts", templateFunction: require("./admin/i18n/it/translations.json") },
	{ name: "admin/i18n/nl/translations.json.ts", templateFunction: require("./admin/i18n/nl/translations.json") },
	{ name: "admin/i18n/pl/translations.json.ts", templateFunction: require("./admin/i18n/pl/translations.json") },
	{ name: "admin/i18n/pt/translations.json.ts", templateFunction: require("./admin/i18n/pt/translations.json") },
	{ name: "admin/i18n/ru/translations.json.ts", templateFunction: require("./admin/i18n/ru/translations.json") },
	{ name: "admin/i18n/uk/translations.json.ts", templateFunction: require("./admin/i18n/uk/translations.json") },

...
const templates: { name: string, templateFunction: TemplateFunction }[] = [
	...
	{ name: "_devcontainer/nginx.conf.ts", templateFunction: require("./_devcontainer/nginx.conf") },
	...
	{ name: "_devcontainer/_Dockerfile.ts", templateFunction: require("./_devcontainer/_Dockerfile") },

...
const templates: { name: string; templateFunction: TemplateFunction }[] = [
	...
	{
		name: "_github/ISSUE_TEMPLATE/bug_report.yml.ts",
		templateFunction: require("./_github/ISSUE_TEMPLATE/bug_report.yml"),
	},
	{ name: "_github/ISSUE_TEMPLATE/config.yml.ts", templateFunction: require("./_github/ISSUE_TEMPLATE/config.yml") },
	{
		name: "_github/ISSUE_TEMPLATE/feature_request.yml.ts",
		templateFunction: require("./_github/ISSUE_TEMPLATE/feature_request.yml"),
	},
	{

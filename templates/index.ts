...
const templates: { name: string, templateFunction: TemplateFunction }[] = [
	...
	{ name: "test/integration.ts", templateFunction: require("./test/integration") },
	...
	{ name: "test/package.ts", templateFunction: require("./test/package") },
	{ name: "test/tsconfig.json.ts", templateFunction: require("./test/tsconfig.json") },
	{ name: "test/unit.ts", templateFunction: require("./test/unit") },
